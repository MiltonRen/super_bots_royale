    ...
    extend: {
      ...
      keyframes: {
        ...
        jump_twice: {
          ...
          '34%':   { transform: 'scale(1,1) translateY(-10%) scaleX(0.95);' },
          '38%':   { transform: 'scale(1,1) translateY(0) scaleX(1.05);' },
          '42%':  { transform: 'scale(1,1) translateY(-10%) scaleX(0.95);' },
          '46%':  { transform: 'scale(1,1) translateY(0) scaleX(1.05);' },
